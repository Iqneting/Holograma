...
@section('content')
  ...
  <a-scene
    ...
    embedded 
    arjs='debugUIEnabled:false; sourceWidth:1280; sourceHeight:960; displayWidth: 1280; displayHeight: 960; sourceType:webcam; trackingMethod: best; cameraParametersUrl: {{$cameraParametersUrl}}; patternRatio: 0.9; maxDetectionRate: 60;'
